 ...
 */
final class Version20220512124455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE direct_message (id INT AUTO_INCREMENT NOT NULL, created_by_id INT NOT NULL, receiver_id INT NOT NULL, content LONGTEXT NOT NULL, has_been_seen TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_1416AF93B03A8386 (created_by_id), INDEX IDX_1416AF93CD53EDB6 (receiver_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

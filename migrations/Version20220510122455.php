 ...
 */
final class Version20220510122455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE topic (id INT AUTO_INCREMENT NOT NULL, created_by_id INT NOT NULL, forums_id INT NOT NULL, created_at DATETIME NOT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_9D40DE1BB03A8386 (created_by_id), INDEX IDX_9D40DE1B618BA34B (forums_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
